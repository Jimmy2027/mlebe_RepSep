...
Cross-subject and cross-study comparability of imaging data in general, whole-brain imaging e.g. MRI) data in particular, is contingent on the quality of registration to a standard reference space.
