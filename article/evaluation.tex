...
(VCF of \py{boilerplate.corecomparison_factorci('Processing[T.Generic Masked]:Contrast[T.CBV]')}).
...
The performance of the Generic SAMRI workflow is significantly different from that of the Generic* workflow, yielding a two-tailed p-value of \py{pytex_printonly('scripts/scf_t.py')}.(TODO: not really?)
