...
(VCF of \py{boilerplate.corecomparison_factorci('Contrast[T.T2w+CBV]')}), nor do we report a notable effect for the contrast-workflow interaction (VCF of \py{boilerplate.corecomparison_factorci('Processing[T.Masked]:Contrast[T.T2w+CBV]')}).
...
(SCF of \py{boilerplate.corecomparison_factorci('Contrast[T.T2w+CBV]', df_path='data/smoothness.csv', dependent_variable='Smoothness Conservation Factor')})
and the contrast-workflow interaction
(SCF of \py{boilerplate.corecomparison_factorci('Processing[T.Masked]:Contrast[T.T2w+CBV]', df_path='data/smoothness.csv', dependent_variable='Smoothness Conservation Factor')}).
