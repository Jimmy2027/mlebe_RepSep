...
the processing workflow (\py{boilerplate.fstatistic('Processing', condensed=True, df_path='data/smoothness_data.csv', dependent_variable='Smoothness Change Factor')}),
the template (\py{boilerplate.fstatistic('Template', condensed=True, df_path='data/smoothness_data.csv', dependent_variable='Smoothness Change Factor')}),
and the interaction thereof (\py{boilerplate.fstatistic('Processing:Template', condensed=True, df_path='data/smoothness_data.csv', dependent_variable='Smoothness Change Factor')}).
...
Given the break-up by contrast shown in \cref{fig:sccv}, we see no notable main effect for the contrast variable (SCF of \py{boilerplate.corecomparison_factorci('Contrast[T.CBV]', df_path='data/smoothness_data.csv', dependent_variable='Smoothness Change Factor')}).
We observe a notable effect for the CBV contrast-Legacy template interaction, introducing a smoothness increase (SCF of \py{boilerplate.corecomparison_factorci('Processing[T.Legacy]:Contrast[T.CBV]', df_path='data/smoothness_data.csv', dependent_variable='Smoothness Change Factor')}).
