...
A Wilcoxon signed-rank test on the absolute distance to 1 of both VCF distributions (rank = \py{boilerplate.wilcoxon_(dependent_variable='1 - Vcf')[0]}, p = \py{boilerplate.wilcoxon_(dependent_variable='1 - Vcf')[1]}) shows that the VCF is sensitive to the workflow.
...
Further, we note that there is a slight variance increase in all conditions for the Generic workflow
...
Further, we note that there is a slight variance increase for the Generic workflow
