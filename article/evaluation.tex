...
%\py{pytex_subfigs(
%	[
%		{'script':'scripts/map_generic.py', 'label':'dsu', 'conf':'article/template.conf', 'options_pre':'{.48\\textwidth}',
...
%			,},
%		{'script':'scripts/map_generic_ambmc.py', 'label':'amb','conf':'article/template.conf', 'options_pre':'{.48\\textwidth}',
