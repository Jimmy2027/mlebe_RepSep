...
workflow (RMSE of \py{boilerplate.bootstrapped_corecomparison_factorci('Processing[T.Generic Masked]')})
and the contrast-workflow interaction (RMSE of \py{boilerplate.bootstrapped_corecomparison_factorci('Processing[T.Generic Masked]:Contrast[T.CBV]')}).
...
\py{pytex_fig('scripts/variance_catplot.py',
        ...
        label='var',
        caption='
                \\textbf{Both the Generic and the Generic Masked workflow minimize trial-to-trial variability while conserving subject-wise variability.}
