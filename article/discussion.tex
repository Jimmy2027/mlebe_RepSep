...
\todo{instead of added transp. and parametrization, I would just write: ... by implementing a fully transparent and parametrized end-to-end python workflow to emphasize more}
