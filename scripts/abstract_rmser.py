...
s_legacy = s_df.loc[(s_df['Processing']=='Legacy') & (s_df['Template']=='Legacy'), 'Smoothness Conservation Factor'].tolist()
...
v_legacy = v_df.loc[(v_df['Processing']=='Legacy') & (v_df['Template']=='Legacy'), 'Volume Conservation Factor'].tolist()
