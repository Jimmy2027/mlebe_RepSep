...
s_legacy = s_df.loc[(s_df['Processing']=='Masked') & (s_df['Template']=='Masked'), 'Smoothness Conservation Factor'].tolist()
...
v_legacy = v_df.loc[(v_df['Processing']=='Masked') & (v_df['Template']=='Masked'), 'Volume Conservation Factor'].tolist()
