...
for i in range(N):
    ...
    masked_CBV_df_temp = choice(masked_CBV_df['Volume Conservation Factor'].to_list(), len(masked_CBV_df['Volume Conservation Factor'].to_list()))
    masked_BOLD_df_temp = choice(masked_BOLD_df['Volume Conservation Factor'].to_list(), len(masked_BOLD_df['Volume Conservation Factor'].to_list()))
