...
def test_generic_masked_preprocess():
    """
...
if __name__ == '__main__':
    test_generic_preprocess()
    test_generic_masked_preprocess()
    test_collapse_bids()
    test_collapse_generic()
    test_collapse_masked()
    test_l1_generic()
    test_l1_masked()
